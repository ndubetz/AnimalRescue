...
public class AnimalInfoViewTest {
	...
	public void testBasicInfoPanel() throws Exception {
		...
		String expectedBirthdate = animalInfoView.getCat()
				.getBirthdateAsDateFormattedString();
		String expectedArrivaldate = animalInfoView.getCat()
				.getArrivalDateAsDateFormattedString();
		String expectedDepaturedate = animalInfoView.getCat()
				.getDepartureDateAsDateFormattedString();
