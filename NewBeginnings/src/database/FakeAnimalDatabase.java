...
public class FakeAnimalDatabase implements IAnimalDatabase
{
	...
	{	
		...
		_fakeCats.add(new Cat("NB-14-003", "Boots", Calendar.getInstance(), "M", "Siberian", "Jet Black", "yes", Calendar.getInstance(), Calendar.getInstance(), "10/11/12, 3 year", "FiV+ FlV-", "1 year", new String[]{"10-4-2014 | Got rabies shot", "11-2-2014 | Open heart surgery"}));
		_fakeCats.add(new Cat("NB-14-001", "Storm", Calendar.getInstance(), "F", "Aegean", "Brown and White", "10/14/14", Calendar.getInstance(), Calendar.getInstance(), "September 3rd 2014, 1 year", "FiV- FlV-", "3 year", new String[]{"9-10-2014 | Gave bith to kittens"}));
